...
public class Ex01_array {
 public static void main(String[] args) {
	 ...
	 //      생성 할 때 반드시 크기를 지정해야 된다. (지정하지 않으면 오류남)
	 ...
	 su[3] = 124;
	 //su[4] = 14; // 배열크기보다ㅏ 크면 실행 오류
	 su[0] = 12; // 현재 데이터를 삭제 하고 12가 저장된다.(변수와 같음)
	 
	 // 배열을 호출 하면 주소 (생성ID)기 출력
	...
	// 개선된 for문 : 배열이나 컬렉션에 주로 사용
	 ...
	 // : => 오른 쪽 배열의 데이터를 하나씩 순서대로 왼 쪽에 넘긴다.
	 for (int k : su) { // su배열을 처음부터 끝까지 하나씩 k에 넣어주세요
