...
public class Ex06_List {
	...
	public static void main(String[] args) {
		...
		//둘리 위치 찾기 2가지 방법
			System.out.println(stack.indexOf("둘리")); // 왼쪽 0부터 시작 => 대부분 이거를 쓰삼
			System.out.println(stack.search("둘리")); // 오른쪽 1부터 시작
			
		// 위치값을 이용해서 객체 얻기 2가지 방법
			System.out.println(stack.get(1)); // 대부분 이거를 쓰삼
