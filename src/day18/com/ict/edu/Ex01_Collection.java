...
public class Ex01_Collection {
	...
	// Collection<E>을 상속 받아서 실제로 사용 하는 인터페이스들은 : Set<E>, List<E>, Queue<E>
	...
	// isEmpty() : boolean => 해당 컬렉션리 비어 있으면 true 
	// iterator() : Iterator<E> => 컬렉션 안에 존재하는 객체들을 순서대로 접근하기 위해서 
	//                             Iterator 객체를 반환
	//                             요소들을 하나씩 꺼내서 작업 할 때 사용 (for문도 사용 가능)
	// remove(Object o) : boolean => 인자로 들어온 객체를 삭제, 성공하면 true 
	// Size() : int => 컬렉션 안에 존재하는 요소의 수 (for문을 사용 할 수 있다.)
