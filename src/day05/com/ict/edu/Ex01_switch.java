...
public class Ex01_switch {
	public static void main(String[] args) {
		 ...
		 * 형식 ) switch (인자값 = inat, char, String){
		          case 조건값1: 인자값과 조건값1이 같은 때 수행할 문장 ; break;
		          case 조건값2: 인자값과 조건값2이 같은 때 수행할 문장 ; 
		                       인자값과 조건값2이 같은 때 수행할 문장 ; break;
		          case 조건값3: 인자값과 조건값3이 같은 때 수행할 문장 ; break;
		 		  default : 조건값 1,2,3 모두 같지 않을 때 (나머지) 수행할 문장; break;
		      
		      ** 주의사항 : break가 없으면 break를 만날때까지 모든 실행문을 실행한다.
		         break의 역할은 실행중임 범위 ( {}블록 )을 벗어나는 역랄을 한다.
		         default는 생략 가능하다.
		          
		 */
		
		//int k1 = 1이면 카페모카, 2이면 카페라떼, 3이면 아메리카노, 4면 과일쥬스를 출력하자.
		int k1 = 2;
		String res = "";
		switch (k1) {
		...
		switch (k2) {
		 ...
		 //char k3이 A,a면 아프리카, B,b면 브라질, C,c면 캐나다, 나머지 한국
		char k3 = 'f';
		switch (k3) {
