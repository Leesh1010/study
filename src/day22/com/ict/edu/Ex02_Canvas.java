...
public class Ex02_Canvas extends JFrame{
	...
	private class CanvasTest extends Canvas{
		...
		public void paint(Graphics g) {
			...
			// 둥근 모서리 채워진 사각형 :fillRoundReck(시작위치, 높이, 넓이, 호넓이, 호높이)
			...
			// 채웢ㄴ 원 : fillOval (시작위치, 넓이, 높이)
			// 색지정 : Color(0~255(r),0~255(g),0~255(b))
			...
			g.drawImage(image,120,230,100,100,this); // 크기조정]
			...
			g.drawImage(image2,350,230,100,100, new Color(255,255,0,170),this);
			} catch (Exception e) {
