...
public class Ex02_File {
	public static void main(String[] args) {
		String pathname = "D:\\lsh/exam01.txt";
		...
		try {
			...
			File file2 = new File("D:\\lsh/EXAM/AAA");
			...
			//디렉토리 삭제
			File file4 = new File("D:\\lsh/EXAM/AAA");
			boolean res4 = file4.delete();
			if(res4) {
				System.out.println("디렉토리 AAA삭제 성공");
				File file5 = new File("D:\\lsh/EXAM");
				boolean res5 = file5.delete();
				if(res5) {
					System.out.println("디렉토리 EXAM삭제 성공");
				}else {
					System.out.println("디렉토리 EXAM삭제 실패");
				}
			}else {
