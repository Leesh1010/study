...
public class ChatClient extends JFrame implements Runnable {
	...
	public ChatClient() {
		...
		img.setIcon(new ImageIcon(ChatClient.class.getResource("/images2/chat.PNG")));
		...
		room_list = new JList();
		room_list.setFont(new Font("Sandoll 삼립호빵체 TTF Basic", Font.PLAIN, 20));
...
// 엔트쳐도 보내진다
	...
	private boolean connected() {
		boolean value = true;
		try {
			s = new Socket("192.168.0.24", 7779);
